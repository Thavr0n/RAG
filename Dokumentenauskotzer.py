...
AlleDokumente = Chroma(persist_directory="/home/ssaman/SimpleRAG/SimpleRAG/venv/Datenbank", embedding_function=emb)
print("Lade Vektordatenbank mit grünem Wissen...")

if not AlleDokumente:
...
QUERY_PROMPT = PromptTemplate(
    ...
    template="""You are an AI language model assistant. You answer in german only. 
    All the documents are in german. Your task is to generate five different versions 
